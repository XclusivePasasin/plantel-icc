...
export function formatPackingDB(data) {
    ...
    return {
        ...
        materials: materialsArray.map(ng => {
            return {
                material_id: ng && ng.id ? ng.id : 0,
                code: ng && ng.code ? ng.code : null,
                description: ng && ng.description ? ng.description : null,
                process: ng && ng.process ? ng.process : null,
                required_amount: ng && ng.required_amount ? ng.required_amount : null,
                unit: ng && ng.unit ? ng.unit : null,
                stock: ng && ng.stock ? ng.stock : null,
                almacen: ng && ng.almacen ? ng.almacen : null,
                lot1: ng && typeof ng.lot1 !== 'undefined' ? ng.lot1 : null,
                entrega1: ng && typeof ng.entrega1 !== 'undefined' ? ng.entrega1 : null,
                entrega2: ng && typeof ng.entrega2 !== 'undefined' ? ng.entrega2 : null,
                return: ng && typeof ng.return !== 'undefined' ? ng.return : null
            }
        })
    }
}
